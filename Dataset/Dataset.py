...
class Dataset:
    ...
    def _getCredentials(self, credentialsFilePath: str):
        try:
            ...
            raise Exception(
                (
                    f"You are missing {credentialsFilePath}" + "or it "
    ...
    def _setupDatabase(self):
        ...
        cursor.execute(
            (
                f"CREATE TABLE {self.GENERAL_TABLE_NAME}"
        ...
        cursor.execute(
            (
                f"CREATE TABLE {self.NEIGHBOURHOOD_TABLE_NAME}" + " (city "
        ...
        cursor.execute(
            (
                f"CREATE TABLE {self.CITIES_TABLE_NAME}"
                + " (id INT AUTO_INCREMENT PRIMARY"
